...
def main():
    ...
    parser.add_argument("--num_images", type=int, default=150,
    ...
    parser.add_argument("--label", type=str, default="cube",
                        # cube should be the default for now
    ...
    for i in range(args.num_images):
        ...
        # Use GrabCut to extract a polygon outline (50-point polygon).
        ...
        # Draw the extracted polygon on a copy of the image.
