...
def main():
    ...
    parser.add_argument("output_folder", type=str,
                        help="Main folder for the training set (this folder will be named 'data' and contain four subfolders: training, validation, testing, and annotated).")
    ...
    parser.add_argument("--base_image_size", type=int, default=256,
                        help="Base output image size in pixels (default: 256)")
    ...
    parser.add_argument("--radius_threshold", type=float, default=0.05,
                        help="If the object's radius is below this value, resolution is increased (default: 0.05)")
    ...
    # data/training, data/validation, data/testing for original images,
    # and data/annotated for annotated images.
    ...
    for i in range(total_images):
        # Wider range for camera parameters.
        fov = random.uniform(20, 100)
        ...
        light_x = random.uniform(-5, 5)
        light_y = random.uniform(-5, 5)
        light_z = random.uniform(-5, -1)
