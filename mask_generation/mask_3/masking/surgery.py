...
class SurgeryDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        ...
        self.add_class("cube", 1, "cube_testing")
        # self.add_class("surgery", 2, "ring")

        # This really shouldn't need to be ran ever
        if hc is True:
            for i in range(1,14):
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "cube_testing":
...
def train(model, *dic):
    ...
    dataset_train.load_VIA(args.dataset, "training")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = SurgeryDataset()
    dataset_val.load_VIA(args.dataset, "validation")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/Users/timli/MarkerlessLocalization/mask_generation/mask_3/data",
                        help='Directory of the surgery dataset')
    parser.add_argument('--weights', required=True,
                        metavar="/Users/timli/MarkerlessLocalization/mask_generation/mask_3/mask_rcnn_coco.h5",
